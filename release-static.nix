...
let
  ...
  static-haskell-nix =
      ...
      fetchTarball https://github.com/nh2/static-haskell-nix/archive/761f34bb4b09dd5838f82782c5e56ebfac4039fb.tar.gz;
  ...
  stack2nix-script = import "${static-haskell-nix}/static-stack2nix-builder/stack2nix-script.nix" {
    ...
    hackageSnapshot = "2019-09-04T00:00:00Z"; # pins e.g. extra-deps without hashes or revisions
  };
